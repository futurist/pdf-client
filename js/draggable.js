(function (root, factory) {
  ...
  */
  ...
  Draggable.array = [];
  Draggable.stopAll = function (e) {
      for( var i=0; i<Draggable.array.length; i++ ){
        Draggable.array[i].stop(e);
      }
  }
  ...
  $.extend (Draggable.prototype, {
    ...
    initialize: function() {
      ...
      if (options.setCursor) {
        style.cursor = options.setCursor;
      }
      ...
      Draggable.array.push(me);

      // attach mousedown event
      me.$element.on(me.handlers.start);
      element.setAttribute('data-drag-id', Draggable.array.length-1);
    ...
    start: function (e) {
      ...
      if(me.options.setPosition) element.style.zIndex = 10000;
    ...
    stop: function (e) {
      ...
      if(me.options.setPosition) element.style.zIndex = dragEvent.oldZindex;
    ...
    setPosition: function() {
      ...
      $.extend(me._dimensions, me.options.calcXY(me)|| {
