	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
			...
			html.push("<span id='", node.tId, consts.id.ICON,
				...
				"' style='", view.makeNodeIcoStyle(setting, node), "'></span><span class='zNodeText' id='", node.tId, consts.id.SPAN,
				"'>",name,"</span>");
		},
		...
		makeDOMNodeNameBefore: function(html, setting, node) {
			...
			html.push("<a id='", node.tId, consts.id.A, "' class='", consts.className.LEVEL, node.level," zNodeA' treeNode", consts.id.A," onclick=\"", (node.click || ''),
